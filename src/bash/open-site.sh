...
#------------------------------------------------------------------------------
mv ./index.md $(echo $SAVE_INDEX_FILE)
mv ./_config.yml $(echo $SAVE_CONFIG_FILE)
mv $(echo $SAVE_THEME_FILE) ./src/samples/$SAVE_SITE/_sass/yolo/themes/
mv $(echo $SAVE_DATA_FILES) ./src/samples/$SAVE_SITE/_data/
mv $(echo $SAVE_IMAGE_FILES) ./src/samples/$SAVE_SITE/assets/images/
mv ./yolo.json ./src/samples/$SAVE_SITE/
#------------------------------------------------------------------------------
